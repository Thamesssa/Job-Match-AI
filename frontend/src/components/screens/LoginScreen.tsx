    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0078D7] to-[#4CAF50] flex items-center justify-center p-6">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl text-white mb-2">JobMatch AI</h1>
        ...
        <div className="bg-white rounded-3xl p-8 shadow-2xl">
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full bg-gradient-to-r from-[#0078D7] to-[#4CAF50] text-white py-4 rounded-xl shadow-lg hover:shadow-xl transition-all duration-200"
            >
          ...
          <div className="mt-6">
            ...
            <div className="mt-4 grid grid-cols-2 gap-3">
              <Button className="bg-white border border-gray-200 text-gray-700 py-3 rounded-xl hover:bg-gray-50">
